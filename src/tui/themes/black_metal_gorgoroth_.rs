...
pub struct BlackMetalGorgoroth;

impl SixColorsTwoRowsStyler for BlackMetalGorgoroth {
    ...
    const COLORS: [Color; 6] = [
        ...
        Color::from_u32(0x009b8d7f),
        Color::from_u32(0x008c7f70),
