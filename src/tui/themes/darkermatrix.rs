...
impl SixColorsTwoRowsStyler for Darkermatrix {
    ...
    const FOREGROUND: Color = Color::from_u32(0x004a6828);
    const DARK_FOREGROUND: Color = Color::from_u32(0x003a5818);
    ...
    const HIGHLIGHT_BACKGROUND: Color = Color::from_u32(0x002a4520);
