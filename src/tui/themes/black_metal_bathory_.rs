...
pub struct BlackMetalBathory;

impl SixColorsTwoRowsStyler for BlackMetalBathory {
    ...
    const COLORS: [Color; 6] = [
        ...
        Color::from_u32(0x00fbcb97),
        Color::from_u32(0x00e78a53),
    ...
    const STATUS_BAR_ERROR: Color = Color::from_u32(0x00CB9B67);

    fn id(&self) -> &str {
        "black_metal_bathory_"
    }
