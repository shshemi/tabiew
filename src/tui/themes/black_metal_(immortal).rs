...
pub struct BlackMetalImmortal;

impl SixColorsTwoRowsStyler for BlackMetalImmortal {
    ...
    const COLORS: [Color; 6] = [
        ...
        Color::from_u32(0x007799bb),
        Color::from_u32(0x00556677),
