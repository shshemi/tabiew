...
impl SixColorsTwoRowsStyler for ManPage {
    const BACKGROUND: Color = Color::from_u32(0x00fef49c);
    const LIGHT_BACKGROUND: Color = Color::from_u32(0x00FFFFBC);
    ...
    const ROW_BACKGROUNDS: [Color; 2] = [Color::from_u32(0x00FFFAA2), Color::from_u32(0x00FFFFA8)];
